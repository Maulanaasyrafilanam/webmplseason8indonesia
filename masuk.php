...
<html lang="en">
    <head>
        ...
        <title>UAS PWEB - TOURNAMENT</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <a class="navbar-brand ps-3" ></a>
            ...
            <a class="navbar-brand ps-3" href="masuk.php">poin masuk team </a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Point masuk</h1>
                        <ol class="breadcrumb mb-4">

                            <li class="breadcrumb-item active">tambahkan point pada team yang menang</li>
                        </ol>
                        </div>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                            ...
                            while($data= mysqli_fetch_array(($ambilsemuadatastock))){
                                    ...
                                    $keterangan = $data['keterangan'];
                                        ...
                                        <tr>
                                            <td><?=date('D-d-M-Y-h-s-a',strtotime($tanggal));?></td>
                                            <td><?=$namabarang;?></td>
                                            <td><?=$qty;?></td>
                                            <td><?=$keterangan;?></td>
                                        </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <br>
        <input type="number" name="qty" class="from-control" placeholder="point" required><br>
        <br>
        <input type="text" name="penerima"  class="from-control" placeholder="keterangan" require><br>
        <br>
